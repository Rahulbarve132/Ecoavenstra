  ...
  return (
    <div className='px-4 py-8'>
      ...
      <div className='flex flex-col sm:flex-row justify-center gap-6 sm:gap-10'>
        <div data-aos="zoom-out-up" className='others w-full sm:w-1/4 bg-blue-600  hover:bg-green-600 transition-transform hover:duration-200  rounded-2xl h-auto sm:h-[550px] flex justify-start flex-col p-4 sm:p-6'>
        ...
        <div data-aos="zoom-out-up" className='Ecoavenstra w-full sm:w-1/4 bg-blue-600  hover:bg-green-600  rounded-2xl h-auto sm:h-[550px] flex justify-start flex-col p-4 sm:p-6'>
            <div className='text-white text-2xl sm:text-3xl font-semibold py-4 flex justify-center'>
                At Ecoavenstra
            </div>
            <div className='py-4 flex flex-col gap-2 px-1 sm:px-3 text-white'>
